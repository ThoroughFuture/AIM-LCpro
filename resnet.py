...
class ResNet34_pretrained(nn.Module):
    def __init__(self):
        ...
        self.resnet = create_feature_extractor(resnet,
                                               {'layer1': 'feature1', 'layer2': 'feature2', 'layer3': 'feature3',
                                                'layer4': 'feature4', 'avgpool': 'feature5'})
        self.Linear = nn.Linear(2048, 2)
        # feature1 B*256*64*64
        # feature2 B*512*32*32
        # feature3 B*1024*16*16
        # feature4 B*2048*8*8
        # feature5 B*2048*1*1

    def forward(self, x):
        out = self.resnet(x)['feature5']
